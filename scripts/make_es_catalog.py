...
ES = {
    ...
    "Search in file contents": "Buscar en el contenido de los archivos",
    "Name": "Nombre",
    "Contents": "Contenido",
    "Content search results": "Resultados de búsqueda en contenido",
    "Searching…": "Buscando…",
    "Search failed.": "La búsqueda falló.",
    "No matches found.": "Sin coincidencias.",
    "Type at least 2 characters to search file contents.": "Escribí al menos 2 caracteres para buscar en el contenido.",
    "%(files)s file(s), %(matches)s match(es)": "%(files)s archivo(s), %(matches)s coincidencia(s)",
    ...
    "Revert to the last saved version": "Revertir a la última versión guardada",
    "Bold": "Negrita",
    "Italic": "Cursiva",
